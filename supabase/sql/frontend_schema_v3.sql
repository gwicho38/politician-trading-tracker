...
-- Add columns to politicians if missing
...
DROP POLICY IF EXISTS "anon_read_politicians" ON politicians;
CREATE POLICY "anon_read_politicians" ON politicians FOR SELECT USING (true);
