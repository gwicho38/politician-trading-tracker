...
class SenatePDFParser:
    ...
    def _extract_transactions_from_text(
        ...
        for i, line in enumerate(lines):
            ...
            if dates and (tickers or amounts):
                ...
                self.logger.debug(f"Extracted transaction: {transaction.get('asset_ticker', 'N/A')}")
    ...
    def should_parse_pdf(self, disclosure: Dict[str, Any]) -> bool:
        ...
        is_pdf_only = (
            asset_type == 'PDF DISCLOSED FILING' or
            ticker == 'N/A' or
            'scanned pdf' in asset_name or
            'ptr_link' in asset_name
        )
