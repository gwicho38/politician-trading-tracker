...
class TickerValidator:
    ...
    def _load_common_tickers(self):
        ...
        common_tickers = {
            ...
            "ADBE", "NFLX", "CRM", "INTC", "AMD", "CSCO", "ORCL", "IBM",
            "QCOM", "TXN", "AVGO", "INTU", "NOW", "PANW", "SNOW", "CRWD",

            # Finance
            "JPM", "BAC", "WFC", "C", "GS", "MS", "BLK", "SCHW", "AXP",
            "BK", "USB", "PNC", "TFC", "COF", "FRC", "STT", "BX", "KKR",

            # Healthcare
            "JNJ", "UNH", "PFE", "ABBV", "TMO", "MRK", "ABT", "DHR", "LLY",
            "BMY", "AMGN", "GILD", "CVS", "CI", "ISRG", "MDT", "SYK", "VRTX",

            # Consumer
            "AMZN", "TSLA", "HD", "NKE", "MCD", "SBUX", "TGT", "LOW", "TJX",
            "DIS", "CMCSA", "VZ", "T", "NFLX", "PYPL", "MA", "V", "COST",

            # Energy
            "XOM", "CVX", "COP", "SLB", "EOG", "MPC", "PSX", "VLO", "OXY",
            "HAL", "PXD", "KMI", "WMB", "LNG", "FANG", "DVN", "HES", "MRO",

            # Industrials
            "BA", "CAT", "GE", "HON", "UNP", "UPS", "RTX", "LMT", "DE",
            "MMM", "FDX", "NSC", "CSX", "EMR", "ETN", "ITW", "PH", "CMI",

            # Materials
            "LIN", "APD", "ECL", "SHW", "FCX", "NEM", "DD", "DOW", "PPG",
            "NUE", "VMC", "MLM", "ALB", "CF", "MOS", "IFF", "CE", "FMC",

            # Utilities
            "NEE", "DUK", "SO", "D", "AEP", "EXC", "SRE", "PEG", "XEL",
            "ED", "ES", "AWK", "PPL", "ETR", "FE", "EIX", "DTE", "AEE",

            # Real Estate / REITs
            "AMT", "PLD", "CCI", "EQIX", "PSA", "SPG", "WELL", "DLR", "O",
            "AVB", "EQR", "SBAC", "VTR", "ARE", "MAA", "UDR", "ESS", "EXR",

            # Consumer Staples
            "WMT", "PG", "KO", "PEP", "PM", "COST", "MO", "CL", "MDLZ",
            "EL", "KMB", "GIS", "KHC", "SYY", "HSY", "K", "TSN", "CAG",

            # ETFs (commonly held)
            "SPY", "QQQ", "IWM", "DIA", "VTI", "VOO", "IVV", "VEA", "VWO",
            "AGG", "BND", "LQD", "HYG", "TLT", "GLD", "SLV", "USO", "XLE",

            # Cryptocurren cy-related
            "COIN", "MSTR", "RIOT", "MARA", "SI", "HUT", "BTBT", "CAN",

            # Other notable companies
            "BRK.A", "BRK.B", "BRKB", "BRKA",  # Berkshire Hathaway
        }
